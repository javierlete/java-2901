...
public class Cita {
	...
	public Cita(Long id, String texto, Long idUsuario, LocalDateTime inicio,
			LocalDateTime fin) {
	...
	public Cita(String texto, Long idUsuario, LocalDateTime inicio, LocalDateTime fin) {
		this(null, new Usuario(idUsuario, null), texto, inicio, fin);
	}
