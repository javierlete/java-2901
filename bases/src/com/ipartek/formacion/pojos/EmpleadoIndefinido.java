...
public class EmpleadoIndefinido extends Empleado {
	...
	public EmpleadoIndefinido(Long id, String nombre, LocalDate fechaNacimiento, Integer numeroPagas,
			BigDecimal sueldoAnual) {
		super(id, nombre, fechaNacimiento);
		this.numeroPagas = numeroPagas;
		this.sueldoAnual = sueldoAnual;
	}

	public EmpleadoIndefinido(String nombre, LocalDate fechaNacimiento, Integer numeroPagas,
			BigDecimal sueldoAnual) {
		this(null, nombre, fechaNacimiento, numeroPagas, sueldoAnual);
	}
	...
	public String toString() {
		return String.format("EmpleadoIndefinido [numeroPagas=%s, sueldoAnual=%s]", numeroPagas, sueldoAnual);
	}
